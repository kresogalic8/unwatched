...
it('spaces routine NPC plans without throttling subscribers or urgent decisions',()=>{
 const a={owner:null,brainKind:'hosted',asleep:false,thinkEvery:null,lastThought:0,lastHungerThought:0,needs:{hunger:0},letters:[],plan:{day:1,steps:[{hour:8,do:'work',place:null}]},location:'market'} as unknown as AgentState;
