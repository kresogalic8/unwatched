...
const at=(day:number)=>{town.day=day;town.t=Math.max(town.t,(day-1)*1440+600);};
...
if(town.events.some((e,i)=>i>0 && e.t<town.events[i-1]!.t))throw Error("Scenario clock moved backwards");
