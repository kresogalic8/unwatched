...
export default function PrivacyPage() {
  return <main className="mx-auto max-w-2xl px-6 py-16 text-[#26352d]">
    ...
    <p className="mt-6">We use Google Analytics only after you choose “Allow analytics”. Declining does not limit the app. You can change your choice using the Privacy button.</p>
